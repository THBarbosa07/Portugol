...
programa {
  ...
  funcao ProgramaPrincipal() {
    ...
    faca{
        ...
        senao{
          repete = verdadeiro e (produto_selecionado!=0 e produto_selecionado<=(u.numero_elementos(produtos)))
        }
        limpa()
    }enquanto(repete == verdadeiro e (produto_selecionado!=0 e produto_selecionado<=(u.numero_elementos(produtos))))
